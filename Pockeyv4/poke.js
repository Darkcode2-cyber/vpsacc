...
class PokeyQuest {
    ...
    async main() {
        ...
        while (true) {
            for (let i = 0; i < userData.length; i++) {
                ...
                if (syncResponse && syncResponse.error_code === 'OK') {
                    ...
                    while (syncData.available_taps > 0) {
                        ...
                        const count = Math.min(Math.floor(Math.random() * (30 - 10 + 1)) + 7, syncData.available_taps);
                        ...
                        if (tapResponse && tapResponse.error_code === 'OK') {
                            ...
                            await this.Countdown(Math.floor(Math.random() * (5 - 1 + 1)) + 5);
                        } else {
            ...
            await this.Countdown(Math.floor(Math.random() * (500 - 130 + 1)) + 130);
        }
    }
}
